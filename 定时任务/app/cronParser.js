...
export class CronParser {
   ...
   */
  getCronTaskList() {
    console.log('CronParser getCronTaskList', JSON.stringify(this.taskList));
   ...
   */
  deleteCronTask(id) {
    console.log('CronParser deleteCronTask', this.taskList[id]);
    if (this.taskList[id]) {
   ...
   */
  clearStoreCronList() {
    console.log('CronParser deleteCronTask', JSON.stringify(this.taskList));
