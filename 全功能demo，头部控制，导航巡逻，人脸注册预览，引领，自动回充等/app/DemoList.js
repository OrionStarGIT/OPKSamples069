...
import { View, Text, TouchableOpacity, StyleSheet, DeviceEventEmitter, Button, ScrollView, Dimensions, ImageBackground } from 'react-native';
...
//            let wakeupParam = new WakeupAndPreWakeupStartCheckParam(true, 3, 1.3, 45, true, undefined, true, 5 * 1000, undefined);
        ...
        return (
            ...
            {/*                 <View>
                            ...
                            <View style={{marginTop:2, backgroundColor: '#fff', textAlign: 'center', lex: 1, fontSize: 15, color: '#F7F7F7' }}>
                            ...
                            <View style={{marginTop:2, backgroundColor: '#fff', textAlign: 'center', lex: 1, fontSize: 15, color: '#F7F7F7' }}>
                                ...
                                {this.state.isTrickEnable ? (
                                    <TrickComponent
                                        ...
                                        getTrickStartText={this.getTrickStartText}
