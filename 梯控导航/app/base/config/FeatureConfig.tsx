...
const ENABLED = '1';
const TAG = 'Portal:FeatureConfig';
...
export class FeatureConfig {
    ...
    private static readonly ROBOT_SETTING_TIMEZONE = 'robot_time_zone_code';

    //多楼层配置开关
    private static readonly ROBOT_SETTING_ELEVATOR_CONTROL_ENABLED = 'robot_setting_elevator_control_enabled';
    ...
    private static keys = [FeatureConfig.SETTINGS_CHARGING_CHAT
        ...
        , FeatureConfig.ROBOT_SETTING_TIMEZONE
        , FeatureConfig.ROBOT_SETTING_ELEVATOR_CONTROL_ENABLED
    ];
    ...
    public static isTrickEnable(): boolean {
        ...
        if (this.mConfig.has(this.CONFIG_ENABLE_SMALL_ACTION)) {
            ...
            console.log(TAG, 'get trick enable from config', value);
        } else {
    ...
    public static async isOpenBackReceptionPoint(): Promise<boolean> {
        ...
        if (this.mConfig.has(this.CONFIG_ENABLE_AUTO_BACK_RECEPTION)) {
            ...
            console.log(TAG, 'get back reception from config', value);
        } else {
    ...
    public static getNavLinearSpeed(): number {
        ...
        if (this.mConfig.has(this.CONFIG_NAV_SPEED)) {
            ...
            console.log(TAG, 'get nav speed from config', value);
        } else {
    ...
    public static getGreetLinearSpeed(): string {
        ...
        if (this.mConfig.has(this.CONFIG_GREET_SPEED)) {
            ...
            console.log(TAG, 'get modal speed from config', value);
        } else {
    ...
    public static getSettingPassword(): string {
        ...
        console.log(TAG, 'getSettingPassword value =' + value);
    ...
    public static setPassword(value: string) {
        console.log(TAG, 'setPassword::  value : ' + value);
        this.mSettings.set(this.SETTINGS_PASSWORD, value);
   ...
   */
    ...
    public static setRobotSettingListener(key: string, listener: any) {
        if(!this.mSettingsListener.has(key)){
            ...
            console.log(TAG,"already exist " + key);
        }
    }
    ...
    public static isAllowReply(): boolean {
        ...
        if (this.mConfig.has(this.CONFIG_ENABLE_CHAT_REPLAY)) {
            ...
            console.log(TAG, 'get allow reply from config', value);
        } else {
    ...
    public static async loadCorpName(){
        ...
        console.log(TAG, 'Load settings, key : ' + this.CORP_NAME + '  ' + value);
    ...
    public static async getBackReceptionIntervalTime(): Promise<number> {
        ...
        if (this.mConfig.has(this.CONFIG_BACK_RECEPTION_WAITING_TIME)) {
            ...
            console.log(TAG, 'get back reception time from config', value);
        } else {
    ...
    public static getHomeInvalidTime(): number {
        ...
        if (this.mConfig.has(this.CONFIG_HOME_INVALID_TIME)) {
            ...
            console.log(TAG, 'get home invalid time from config: ', value);
        } else {
            value = 5;
            console.log(TAG, 'get default home invalid time: ', value);
        }
        return value * 1000;
    }
    ...
    public static isMaskDetectionEnable(): boolean {
        ...
        if (this.mConfig.has(this.CONFIG_ENABLE_MASK_DETECTION)) {
            ...
            console.log(TAG, 'get mask detect from config', value);
        } else {
    ...
    public static loadServiceConfig(): void {
        try {
            ...
            console.log(TAG, 'server config', configJson);
            ...
            console.log(TAG, 'config data size', this.mConfig.size);
        } catch (e) {
            console.log(TAG, 'get server config error');
        }
    }
    ...
    public static getTimeZone(): string {
        let value = this.mSettings.get(this.ROBOT_SETTING_TIMEZONE);
        console.log('getTimeZone', 'getTimeZone', value);
        return value;
    }
     ...
     * @returns 
     */
    public static isElevatorControlEnabled(): boolean {
        let value = this.mSettings.get(this.ROBOT_SETTING_ELEVATOR_CONTROL_ENABLED);
        return value == ENABLED;
    }
